...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'waltba04@pfw.edu',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Purdue-Fort-Wayne-ACM',
    },
  ],
